								...
								<div class="col-lg-1 width-200">
									<div class="form-group">
										<select class="default-select2 form-control input-sm" name="searchCondition" id="searchKey" title="검색유형">
											<option value="000">JOB ID & 상태메세지</option>
											<option value="001">JOB ID</option>
						...
						<table width="100%" class="table table-bordered table-striped" id="gridEtlLogList" cellspacing="0">
							<thead>
								<tr>
									...
									<th class="text-center">최종 적재건수</th>
					...
					<div class="col-lg-12">
						<table class="table table-bordered ho-table-border">
							<tr>
								...
								<td id="bJobId" width="75%" colspan="5"></td>
							</tr>
							<tr>
								<th width="15%">최종 적재건수</th>
								<td id="bCount" width="25%"></td>
								<th width="10%">상태</th>
								<td id="bStatus" width="20%"></td>
								<th width="10%">날짜</th>
