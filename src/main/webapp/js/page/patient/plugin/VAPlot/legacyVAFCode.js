/*
original copyright by mskcc dev team
copyleft by 오세영
 */
var GENEPANEL_ICON_WIDTH = 1.25;
var GENEPANEL_ICON_HEIGHT = 1.1;
...
var AlleleFreqPlotUtils = (function() {
 ...
 var AlleleFreqPlotMulti = function(component, id, data, options, order, colors, labels, genepanel_icon_data) {
       ...
       // console.log('labels', labels);
         ...
         // var curve = $("#curve");
         // var show_histogram = histogram.prop("checked");
         // var show_curve     = curve.prop("checked");
         // var component={};
         // component.show_histogram=show_histogram;
         // component.show_curve=show_curve;
    ...
    if (!options.nolegend && dkeys.length > 1) {
