...
<div class="row">
	<section class="col-lg-12">
		...
		<div class="box collapsed-box">
			...
			<div class="box-body">
				<div class="item dataTableDiv" id="patientSearchDiv_02" >
					<table width="100%" class="table table-bordered table-striped text-align-center font-size-datatabls " id="gridSearch_02" cellspacing="0">
						<colgroup>
				...
				<div class="row">
					<div class="col-lg-12" style="text-align:left">
						<div id="divPeriodWrap_02" style="display:none;">
							...
							<table width="100%" class="table table-bordered table-striped text-align-center font-size-datatabls" 
								id="gridPeriod_02" cellspacing="0">
								<colgroup>
									<col style="width:10%;"></col>
									<col style="width:10%;"></col>
									<col style="width:10%;"></col>
						...
						<div id="jqxGridPeriod_02" style="display:none;"></div>
...
<!-- 					<button type="button" class="btn btn-danger btn-xs pull-right" id="btnVisualization" title="" style="margin-right: 5px;">Tableau 시각화</button>
					...
					<button type="button" class='btn btn-warning btn-xs pull-right margin-right-5' style="margin-right: 5px;" id="btnAutoColumns_02" tabNum='0'>열맞춤</button>
		...
		<div class="modal-dialog vertical-align-center">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" onsubmit="return false;" id="frmSearchCondition_cs02-1">
	...
	<div class="vertical-alignment-helper">
		<div class="modal-dialog vertical-align-center">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" onsubmit="return false;" id="frmSearchCondition_cs02-2">
						<div class="form-group">
							<label class="col-md-2 control-label">데이터명</label>
							<div class="col-md-10">
...
<script src="<c:url value="/js/page/research/crossSectionalStudy/sub_02.js" />"></script>
