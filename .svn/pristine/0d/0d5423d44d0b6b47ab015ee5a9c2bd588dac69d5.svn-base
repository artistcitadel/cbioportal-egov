		...
		<div class="box">
			<div class="box-header">
				...
				<div class="pull-right box-tools">
					...
					<!-- <button type="button" id="btnCohortSurvive" class="btn btn-primary btn-xs pull-right" style="margin-right: 5px;">
					생존분석 설정</button> -->
				</div>
			</div>
			<div class="box-body">
				<div class="item" id="">
					...
					<table width="100%" class="table table-bordered table-striped text-align-center font-size-datatabls" id="gridStudyItem" cellspacing="0">
						<colgroup>
...
<div class="row" id="surviveArea">
	<section class="col-lg-12">
		<div class="box collapsed-box" id="divSurvival">
			<div class="box-header">
				<i class="fa fa-comments-o"></i>
				<h3 class="box-title">생존분석</h3>
				<div class="pull-right box-tools">
					<button type="button" class="btn btn-default btn-xs pull-right" 
							data-widget="collapse" 
							data-toggle="tooltip" 
							title="" style="margin-right: 5px;" data-original-title="Collapse">
					<i class="fa fa-plus" id="iFaPlus"></i></button>
					<button type="button" id="btnCohortSurvive" class="btn btn-primary btn-xs pull-right" style="margin-right: 5px;">
					생존분석 설정</button>
				</div>
			</div>
			...
			<div class="box-body">
				<div class="item" id="">
				<!-- style="clear: both;table-layout:fixed;word-wrap:break-word;" -->
					▷ <b>사건정의</b>
					<table 	width="100%" class="table table-bordered table-striped text-align-center font-size-datatabls" 
							id="gridEventList" cellspacing="0">
						<colgroup>
							<col style="width:10%;"></col>
							<col style="width:10%;"></col>
							<col style="width:10%;"></col>
					...
					<div class="row margin-bottom-10">
						<div class="col-lg-6" style="text-align:left">
							<button type="button" id="btnEventInitGroup" class="btn btn-warning btn-sm">그룹 초기화</button>
							<button type="button" id="btnEventInit" class="btn btn-danger btn-sm">초기화</button>
						</div>
				...
				<div class="item" style="margin-top:10px;">
					▷ <b>중도절단</b>
					<table width="100%" class="table table-bordered table-striped text-align-center font-size-datatabls" 
						id="gridCensoredDataList" cellspacing="0">
						<colgroup>
							<col style="width:10%;"></col>
							<col style="width:10%;"></col>
							<col style="width:10%;"></col>
					...
					<div class="row margin-bottom-10">
						<div class="col-lg-6" style="text-align:left">
							<button type="button" id="btnCensoredInitGroup" class="btn btn-warning btn-sm">그룹 초기화</button>
							<button type="button" id="btnCensoredInit" class="btn btn-danger btn-sm">초기화</button>
						</div>
			...
			<!-- <div class="box-footer">
				<div class="row margin-bottom-10">
					<div class="col-lg-6" style="text-align:left">
						<button type="button" id="btnEventInitGroup" class="btn btn-warning btn-sm">사건정의 그룹 초기화</button>
						<button type="button" id="btnEventInit" class="btn btn-danger btn-sm">사건정의 초기화</button>
					</div>
		...
		<div class="modal-dialog vertical-align-center">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" onsubmit="return false;" id="frmSearchCondition_ch02-1">
		...
		<div class="modal-dialog vertical-align-center">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h5 class="modal-title" id="myModalLabel">연구항목 검색결과 저장</h5>
				</div>
				<div class="modal-body">
					<form class="form-horizontal" onsubmit="return false;" id="frmSearchCondition_ch02-2">
						<div class="form-group">
							<label class="col-md-2 control-label">연구이름</label>
							<div class="col-md-10">
...
<script src="<c:url value="/js/page/research/cohort/sub_02.js" />"></script>
